...
<body>
	...
	<div class="right" id="mainFrame">
		...
		<%
			DingdanManager manager1 = new DingdanManager();
			ArrayList list1 = manager1.getAll();
		%>
	<div class="sousuo"><div class="sousuo2"><span style="padding-left:10px;padding-right:10px;">按订单状态查看</span><select name="dingdanchakan" size="0" style="width:150px; height:30px;">
	<option value="all" >全部</option>
        ...
        <br /><br />
		  ...
		  <form id="form2" name="form2" method="post"
			action="<%=request.getContextPath()%>/jsp/h_order.jsp">
							...
							%>								
                             ...
                             <!--     	<td><strong>订单总额</strong></td>   -->
								...
								<tr>
									...
									<td>
									<a
								href="<%=request.getContextPath()%>/jsp/h_orderxiangxi.jsp?id=<%=((DingdanBean) list.get(i)).getId()%>"
								class="button1">详细信息</a>
									<a href="<%=request.getContextPath()%>/typeDel?id=<%=((DingdanBean) list.get(i)).getId()%>"
										class="button1">删除
									</a></td>
								</tr>
								<%
							...
							<table width="1119" align="center"
                             ...
                             <!--     	<td><strong>订单总额</strong></td>   -->
								...
								<tr>
									...
									<td>
									<a
								href="<%=request.getContextPath()%>/jsp/h_orderxiangxi.jsp?id=<%=((DingdanBean) Onelist.get(i)).getId()%>"
								class="button1">详细信息</a>
									<a href="<%=request.getContextPath()%>/typeDel?id=<%=((DingdanBean) Onelist.get(i)).getId()%>"
										class="button1">删除</a>
									</td>
								</tr>
								<%
