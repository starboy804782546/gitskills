	...
	<div class="right" id="mainFrame">
		...
		<div class="body">
			<div class="div1" id="div1">
				<input type="button" class="button_active" value="浏览" name="input"
					onclick="onType();" /><input type="button" class="button"
					value="添加" name="input" onclick="onType();" />


				<div style="display: block;" name="div2" class="div2class">
					<form id="form1" name="form1" method="post"
						onsubmit="return zeroCheck();"
						action="<%=request.getContextPath()%>/typeDelete">
						<div class="li">
							<input type="submit" align="center" style="border: 0px;"
								value="删除">
						</div>
						<div class="content">
							...
							<table width="1119" align="center"
								...
								<tr>
									...
									<td width="298"><strong>操作</strong></td>
								</tr>
								<%
				...
				<div name="div2" style="display: none;" class="div2class">这里显示添加</div>
			</div>
			<!--div1_end-->
			<script>
				function onType() {
