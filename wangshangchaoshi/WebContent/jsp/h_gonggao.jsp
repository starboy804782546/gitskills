...
<body>
	...
	<div class="right" id="mainFrame">
		...
		<%
			...
			ArrayList<User> list = guanli.AllUsers();
		%>
		<div class="body"><div class="huixian"><%= request.getAttribute("bianhao")==null?"":request.getAttribute("bianhao")%></div>
					<form id="form1" name="form1" method="post"
						onsubmit="return zeroCheck();"
						action="<%=request.getContextPath()%>/GonggaoServlet">
						<div class="li">
							<input type="submit" class="button" style="border: 0px;"
								value="删除">
								<a href="<%=request.getContextPath()%>/jsp/h_gonggaoadd.jsp" class="button">添加</a>
						</div>
						<div class="content">
							...
							<table width="1119" align="center"
								...
								<tr>
									...
									<td width="500"><strong>标题</strong></td>
								...
								<tr>
									<td><input type="checkbox" name="checkbox"
										value="<%=((User)list.get(i)).getBianhao()%>" /></td>
									<td height="25"><%=((User)list.get(i)).getBiaoti()%></td>
                                    <td><%=((User)list.get(i)).getShijian()%></td>
                                    
                                    
									<td><a href="<%=request.getContextPath()%>/jsp/h_gonggaoupdate.jsp?id=<%=((User)list.get(i)).getBianhao()%>" class="button1">修改 </a><span></span><a
										href="<%=request.getContextPath()%>/GonggaoServlet?bianhao=<%=((User)list.get(i)).getBianhao()%>"
